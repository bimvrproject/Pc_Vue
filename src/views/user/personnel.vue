		...
		<div>
			...
			<div class="hometopjzmper" v-show="hometop">
				...
				<el-dropdown style="float: left;margin-left:-1.4rem;">
					<div class="el-dropdown-link" @click="fnperxm()">
						<img class="xmimgper" src="../../assets/image/bluefz.png" alt="" style="vertical-align:text-bottom;"/>
						<span class="xmper">项目</span>
				...
				<el-dropdown style="float: left; margin-left:1.5rem;">
					<div class="el-dropdown-link" @click="fnpersq()"  @mouseenter="fnhsq()" @mouseleave="fnhsqlev()">
						<img class="sqimgper" :src="hsq" style="vertical-align:text-bottom;"/>
...
export default {
	...
	created() {
		// 接收一下title
		this.projecttitperson = sessionStorage.getItem('projecttit');
		// 人员信息填写中的账号
...
.moretopcomper:hover .moocomper{
		  display:block;
	}
	.moretopcomper:hover .hgmorecomper{
		 color:#2180ED
	}
	.moretopcomper:hover .shouye{
