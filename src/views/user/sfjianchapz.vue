		...
		<div>
			...
			<div class="hometopjzmsfjc" v-show="hometop">
				...
				<el-dropdown style="float: left;margin-left:-1.4rem;">
					<div class="el-dropdown-link" @click="fnsfxm">
						<img class="xmimgsfjc" src="../../assets/image/bluefz.png" style="vertical-align:text-bottom;"/>
				...
				<el-dropdown style="float: left; margin-left:1.5rem;">
					<div class="el-dropdown-link" @click="fnsfsq" @mouseenter="fnhsq()" @mouseleave="fnhsqlev()">
						<img class="sqimgsfjc" :src="hsq" style="vertical-align:text-bottom;"/>
					   ...
					   <span class="hgmorecomsfjc">更多</span>
						<i style="display:inline-block;width:0.45rem;height:0.53125rem‬;margin-left:0.2rem;">
						  ...
						  <div class="moocomsfjc" style="margin-top:0.1rem;">
						 	...
						 	<div class="moresbcomsfjc">版本号: v 1.0.3</div>
						 </div>
				</div>
				<!-- 下拉菜单---更多--结束 -->
			</div>
...
export default {
	...
	created() {
		// 接收一下建筑项目中的title
			this.projecttitsfjcgxpz = sessionStorage.getItem('projecttit');
