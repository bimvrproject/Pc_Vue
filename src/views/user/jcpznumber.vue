		...
		<div class="box">
			...
			<div class="hometopjzmjcpz" v-show="hometop">
				...
				<el-dropdown style="float: left;margin-left:-1.4rem;">
					<div class="el-dropdown-link" @click="fnjcxm">
						<img class="xmimgjcpz" src="../../assets/image/bluefz.png" style="vertical-align:text-bottom;"/>
				...
				<el-dropdown style="float: left; margin-left:1.5rem;">
					<div class="el-dropdown-link" @click="fnjcsq"  @mouseenter="fnhsq()" @mouseleave="fnhsqlev()">
						<img class="sqimgjcpz" :src="hsq" style="vertical-align:text-bottom;"/>
				...
				<div class="moretopcompznum" style="height:0.93125rem;" @mouseenter="fnmorpznum()" @mouseleave="fnmorlevpznum()">
					<img :src="moretb" alt="" style="width:0.84375rem;height:0.8125rem;margin-right:0.16rem;float:left;vertical-align:text-bottom;">
					   <span class="hgmorecompznum">更多</span>
						 <i style="display:inline-block;width:0.45rem;height:0.53125rem‬;margin-left:0.2rem;">
						  ...
						  <div class="moocompznum" style="margin-top:0.1rem;">
						 	...
						 	<div class="moresbcompznum">版本号: v 1.0.3</div>
						 </div>
				</div>
				<!-- 下拉菜单---更多--结束 -->
			</div>
