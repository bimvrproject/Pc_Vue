		...
		<div class="box">
			...
			<div class="hometopjzmjcpz" v-show="hometop">
				...
				<el-dropdown style="float: left; margin-left:1.5rem;">
					<span class="el-dropdown-link" @click="fnjcsq">
						<img class="sqimgjcpz" src="../../assets/image/sq@2x.png" />
						<i class="sqjcpz" style="color: #333;">社区</i>
			...
			<div style="width:18.75rem;height:0.6875rem;position: absolute;top:3.53125rem;left:8.21875rem;text-align:left;cursor:pointer;">
				<span style="margin-right:0.1875rem;color:#2180ED;font-size:0.5rem;font-weight:500;" @click="fnjc">新建项目</span>
				<i style="font-weight:900;font-style:normal;font-size:0.625rem;">/</i>
				<span style="margin-right:0.1875rem;margin-left:0.15625rem;color:#2180ED;font-size:0.5rem;font-weight:500;" @click="fnjcg">管线综合</span>
				<i style="font-weight:900;font-style:normal;font-size:0.625rem;">/</i>
